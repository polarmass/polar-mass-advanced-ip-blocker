jQuery(document).ready(function ($) {
    ...
    if (cfipAdmin.isSubscribed) {
        ...
        $('.cfip-newsletter').append('<div class="cfip-newsletter-success">' + '<p>You are already subscribed!</p>' + '</div>')
        return
    }
                ...
                if (response.success) {
                    $form.fadeOut(300, function () {
                        const successMessage = $(
                            '<div class="cfip-newsletter-success">' + '<p>Thank you for subscribing to our newsletter!</p>' + '</div>'
                        ).hide()
